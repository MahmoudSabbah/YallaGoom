...
import com.oxygen.yallagoom.interfaces.RejectFriendCallback;
...
public class RejectFriendAsyncTask extends AsyncTask<String, String, Integer> {
    private final Context mContext;
    private final RejectFriendCallback rejectFriendCallback;
    private KProgressHUD progress;
    private String error;

    public RejectFriendAsyncTask(Context context, RejectFriendCallback rejectFriendCallback) {
        mContext = context;
        this.rejectFriendCallback = rejectFriendCallback;
    ...
    protected Integer doInBackground(String[] params) {
        ...
        builder.url(Constant.urlData + Constant.reject_friend);
    ...
    protected void onPostExecute(Integer status) {
        ...
        progress.dismiss();
        if (status == 1) {
            ToolUtils.viewToast(mContext,mContext.getString(R.string.reject_friend));
            rejectFriendCallback.processFinish();
        } else {

...
import com.oxygen.yallagoom.entity.Matches.MatchDetails;
...
public class GetClubCompitetionListApiAsyncTask extends AsyncTask<String, String, Integer> {
    ...
    public GetClubCompitetionListApiAsyncTask(Context context, StringResultCallback stringResultCallback) {
        mContext = context;
    ...
    protected Integer doInBackground(String[] params) {
        ...
        formBody.add("area_id",params[0]);
        Request.Builder builder = new Request.Builder();
        builder.url(Constant.urlData + Constant.get_club_compitetion_list);

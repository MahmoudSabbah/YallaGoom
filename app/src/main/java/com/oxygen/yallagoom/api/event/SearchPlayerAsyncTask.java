...
public class SearchPlayerAsyncTask extends AsyncTask<String, String, Integer> {
    ...
    public SearchPlayerAsyncTask(Context context, String type, String player_name, String gender,
    ...
    protected Integer doInBackground(String[] params) {
        ...
        Log.e("SearchPlayer_body",""+ ToolUtils.bodyToString(request));

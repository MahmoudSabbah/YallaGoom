...
public class OfferFragmentDataAsyncTask extends AsyncTask<String, String, Integer> {
    ...
    public OfferFragmentDataAsyncTask(Context context, StringResultCallback stringResultCallback) {
        mContext = context;
    ...
    protected Integer doInBackground(String[] params) {
        ...
        if (MainApplication.verification_check) {
            builder.url(Constant.urlData + Constant.special_offers_with_auth);
            ...
            builder.url(Constant.urlData + Constant.special_offers);

...
import com.oxygen.yallagoom.interfaces.BlockFriendCallback;
...
public class BlockFriendAsyncTask extends AsyncTask<String, String, Integer> {
    private final Context mContext;
    private final BlockFriendCallback blockFriendCallback;
    private KProgressHUD progress;
    private String error;

    public BlockFriendAsyncTask(Context context , BlockFriendCallback blockFriendCallback) {
        mContext = context;
        this.blockFriendCallback=blockFriendCallback;
    ...
    protected Integer doInBackground(String[] params) {
        ...
        builder.url(Constant.urlData + Constant.block_friend);
    ...
    protected void onPostExecute(Integer status) {
        ...
        progress.dismiss();
        if (status == 1) {
          //  ToolUtils.viewToast(mContext, mContext.getString(R.string.block_friend));
            blockFriendCallback.processFinish();
        } else {

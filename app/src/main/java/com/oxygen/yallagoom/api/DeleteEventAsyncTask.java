...
public class DeleteEventAsyncTask extends AsyncTask<String, String, Integer> {
    private final Context mContext;
    private KProgressHUD progress;
    private String error;

    public DeleteEventAsyncTask(Context context) {
        mContext = context;
    }
    ...
    protected Integer doInBackground(String[] params) {
        ...
        builder.url(Constant.urlData + Constant.delete_event+"/"+params[0]);
        builder.delete();

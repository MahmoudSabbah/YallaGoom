...
import com.oxygen.yallagoom.adapter.SplashPagerAdapter;
import com.oxygen.yallagoom.api.GetChannelsAsyncTask;
import com.oxygen.yallagoom.api.GetCountriesAsyncTask;
import com.oxygen.yallagoom.api.GetCountryCodeAsyncTask;
import com.oxygen.yallagoom.api.GetMyDataProfileApiAsyncTask;
...
import com.oxygen.yallagoom.interfaces.GetCountriesCallback;
import com.oxygen.yallagoom.interfaces.GetCountryCodeCallback;
import com.oxygen.yallagoom.interfaces.StringResultCallback;
import com.oxygen.yallagoom.utils.Constant;
import com.oxygen.yallagoom.utils.ToolUtils;
import com.oxygen.yallagoom.widget.animator.ViewAnimator;
...
public class SplashScreenActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ToolUtils.hideStatus(SplashScreenActivity.this);
         sharedPreferences = ToolUtils.getSharedPreferences(this, Constant.FirstTimeShared);
        checkFirstTime = sharedPreferences.getBoolean(Constant.CheckFirstTime, true);
                                    ...
                                    public void processFinish(Country country) {
                                        ...
                                        if (MainApplication.verification_check) {
                                            ...
                                            if (!checkFirstTime){
                                                ...
                                                ToolUtils.setSharedPrefernce(SplashScreenActivity.this, Constant.FirstTimeShared).putBoolean(Constant.CheckFirstTime,false).apply();
                                            }

package com.oxygen.yallagoom.adapter.Score.ClubsTab;
...
public class RecycleViewClubsDetailsMatches extends RecyclerView.Adapter<RecycleViewClubsDetailsMatches.MyViewHolder>  {
    ...
    public RecycleViewClubsDetailsMatches(Activity activity, ArrayList<MatchesList> all_matches_in_last_season) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_clubs_details_matches, parent, false);

...
import com.oxygen.yallagoom.entity.Matches.Player.Player_incident_data_count;

import java.util.ArrayList;

public class RecycleViewPlayerDetailsAction extends RecyclerView.Adapter<RecycleViewPlayerDetailsAction.MyViewHolder>  {
    ...
    public RecycleViewPlayerDetailsAction(Activity activity, ArrayList<Player_incident_data_count> incident_count) {

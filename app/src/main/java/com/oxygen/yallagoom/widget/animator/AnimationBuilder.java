package com.oxygen.yallagoom.widget.animator;
...
public class AnimationBuilder {
    ...
    public AnimationBuilder property2(String propertyName, float... values) {
        for (View view : views) {
    ...
    public AnimationBuilder translationY2(float... y) {
        return property2("translationY", y);
    }
    /**
    ...
    public AnimationBuilder translationX2(float... x) {
        return property2("translationX", x);
    }

package com.oxygen.yallagoom.widget.compactcalendarview;
...
import static com.oxygen.yallagoom.widget.compactcalendarview.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.oxygen.yallagoom.widget.compactcalendarview.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.oxygen.yallagoom.widget.compactcalendarview.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    private void drawEventIndicatorCircle(Canvas canvas, float x, float y, int color) {
        if (eventIndicatorStyle == SMALL_INDICATOR) {
         ...
         //   canvas.drawText("3",x,y,dayPaint);
        }
    }

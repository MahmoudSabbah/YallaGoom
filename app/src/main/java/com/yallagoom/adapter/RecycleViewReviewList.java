...
public class RecycleViewReviewList extends RecyclerView.Adapter<RecycleViewReviewList.MyViewHolder> {
    ...
    @Override
    public RecycleViewReviewList.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_review, parent, false);

        return new RecycleViewReviewList.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final RecycleViewReviewList.MyViewHolder holder, final int position) {

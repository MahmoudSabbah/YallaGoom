...
public class RecycleViewGenderLevel extends RecyclerView.Adapter<RecycleViewGenderLevel.MyViewHolder> {
    ...
    public RecycleViewGenderLevel(List<String> alertList) {

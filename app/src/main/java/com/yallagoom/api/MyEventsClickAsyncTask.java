...
public class MyEventsClickAsyncTask extends AsyncTask<String, String, Integer> {
    ...
    public MyEventsClickAsyncTask(Context context, MyEventCallback myEventCallback) {
        mContext = context;
